...
Since Nibio and MET have different names for the same stations the authors desided to compile a simple request to the Frost API where the following query was submitted; \begin{verbatim}
	"https://frost.met.no/observations/v0.csv?sources=ID&referencetime=2014-03-1%2F2020-10-31&elements=sum(precipitation_amount%20PT1H)"
\end{verbatim} Where ID is the station ID used by Frost API / MET
